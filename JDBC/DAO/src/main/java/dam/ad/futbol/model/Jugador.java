...
public class Jugador {
    ...
    public Jugador(int jugadorId, String nombre, String pais, LocalDate nacimiento, double estatura, int peso, int dorsal, int equipoId, boolean capital) {
